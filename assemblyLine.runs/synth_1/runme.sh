...
HD_PWD='C:/Users/DV013/Desktop/assemblyLine/assemblyLine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_lwip_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_lwip_wrapper.tcl
