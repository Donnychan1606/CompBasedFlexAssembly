...
HD_PWD='D:/Z7-LITE-7020/04_SDK_Demo/10_ps_lwip/ps_lwip/ps_lwip.runs/ps_lwip_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_lwip_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_lwip_processing_system7_0_0.tcl
