...
HD_PWD='C:/Users/DV013/Desktop/assemblyLine/assemblyLine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_lwip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_lwip_wrapper.tcl -notrace
